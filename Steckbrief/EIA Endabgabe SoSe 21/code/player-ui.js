...
(function (Endabgabe) {
    ...
    class PlayerUI {
        ...
        static createShotStrength(player) {
            return this.createRangeInput(1, 99, player === null || player === void 0 ? void 0 : player.getShotPower().toString(), strengthHelper);
        ...
        static createSpeed(player) {
            return this.createRangeInput(1, 99, player === null || player === void 0 ? void 0 : player.getSpeed().toString(), speedHelper);
        ...
        static createPrecision(player) {
            return this.createRangeInput(1, 99, player === null || player === void 0 ? void 0 : player.getPrecision().toString(), precisionHelper);
