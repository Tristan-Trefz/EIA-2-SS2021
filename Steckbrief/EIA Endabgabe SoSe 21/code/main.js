...
(function (Endabgabe) {
    ...
    function startClock() {
        ...
        setInterval(function () {
            if (animationIsRunning) {
                time += new Date().getTime() - (lastTime === null || lastTime === void 0 ? void 0 : lastTime.getTime());
            }
            lastTime = new Date();
        }, 250);
    }
    ...
    function updateAnimation() {
        ...
        for (let movable of listOfMoveables) {
            ...
            if (mousePos && (currentBallLeaders === null || currentBallLeaders === void 0 ? void 0 : currentBallLeaders.length) > 0) {
