...
function handleLoad(_load) {
    ...
    let c1 = document.querySelector("span.1");
    let c2 = document.querySelector("span.2");
    let c3 = document.querySelector("span.3");
    let c4 = document.querySelector("span.4");
    let c5 = document.querySelector("span.5");
    let c6 = document.querySelector("span.6");
    let c7 = document.querySelector("span.7");
    let c8 = document.querySelector("span.8");
    let c9 = document.querySelector("span.9");
    let c10 = document.querySelector("span.10");
    let c11 = document.querySelector("span.11");
    let c12 = document.querySelector("span.12");
    let c13 = document.querySelector("span.13");
    let c14 = document.querySelector("span.14");
    let c15 = document.querySelector("span.15");
    let c16 = document.querySelector("span.16");
    let c17 = document.querySelector("span.17");
    let c18 = document.querySelector("span.18");
    let c19 = document.querySelector("span.19");
    let c20 = document.querySelector("span.20");
    let c21 = document.querySelector("span.21");
    let c22 = document.querySelector("span.22");
    let c23 = document.querySelector("span.23");
    let c24 = document.querySelector("span.24");
    let c25 = document.querySelector("span.25");
    ...
    function checkPair(_event) {
        let turn;
        if (turn == 1) {
            turn++;
            var card = _event.currentTarget;
            card.classList.remove("X");
        }
        else {
            let card2 = _event.currentTarget;
